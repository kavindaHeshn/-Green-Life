...
<head>
    ...
    <title>Ayurvedic Weight Management Package - GreenLife Wellness Center</title>
    ...
    <style>
        ...
        * {
        ...
        /* Weight Management Package Section */
        .weight-management {
            padding: 60px 20px;
        ...
        .weight-management-content p {
            font-size: 1rem;
            color: #333;
            margin-bottom: 1.5rem;
        }

        .weight-management-content h3 {
            font-family: 'Algerian', serif;
            font-size: 1.8rem;
            color: var(--brown-accent);
            margin-bottom: 1rem;
        ...
        .weight-management-content ul {
            list-style: disc;
            padding-left: 20px;
            margin-bottom: 1.5rem;
        }

        .weight-management-content ul li {
            font-size: 1rem;
            color: #333;
            margin-bottom: 0.5rem;
        }

        .weight-management-content ul li strong {
            color: var(--brown-accent);
        }
...
<body>
    ...
    <section class="intro-section">
        <h2>Ayurvedic Weight Management Package</h2>
        <p>Achieve healthy weight loss and holistic wellness with our personalized Ayurvedic program.</p>
    </section>

    <!-- Weight Management Package Section -->
    <section class="weight-management" id="weight-management" aria-labelledby="weight-management-heading">
        <h2 id="weight-management-heading">Ayurvedic Weight Management Package</h2>
        <img src="../photos/weightmanagement.jpg" alt="Ayurvedic Weight Management Package" class="weight-management-image">
        <div class="weight-management-content">
            <p>At GreenLife Wellness Center, our Ayurvedic Weight Management Package is designed to promote healthy weight loss, boost metabolism, and support holistic wellness through time-honored Ayurvedic practices. This program combines specialized therapies, personalized nutrition, and lifestyle guidance to achieve sustainable results.</p>
            
            <h3>Program Highlights</h3>
            <ul>
                <li><strong>Panchakarma Therapy</strong>: Detoxification therapy to cleanse the body and support weight loss.</li>
                <li><strong>Herbal Remedies</strong>: Utilizes herbs like Triphala and Guggulu to support weight management and digestion.</li>
                <li><strong>Yoga & Meditation</strong>: Tailored asanas and meditation to enhance flexibility, burn calories, and promote mind-body balance.</li>
                <li><strong>Personalized Diet</strong>: Personalized Ayurvedic meal plans to optimize digestion and metabolism.</li>
                <li><strong>Counselling</strong>: Guidance to support mental and emotional well-being during your weight management journey.</li>
            </ul>

            <h3>Benefits</h3>
            <ul>
                <li>Achieves sustainable weight loss and fat reduction.</li>
                <li>Boosts metabolism and energy levels.</li>
                <li>Improves digestion and nutrient absorption.</li>
                <li>Enhances physical and mental well-being.</li>
                <li>Promotes long-term healthy lifestyle habits.</li>
            </ul>
