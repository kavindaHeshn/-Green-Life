...
<head>
    ...
    <title>Physiotherapy - GreenLife Wellness Center</title>
    ...
    <style>
        ...
        * {
        ...
        .logo img {
            ...
            padding: 5px;
            transition: transform 0.3s ease,{Srart} box-shadow 0.3s ease;
        }
...
<body>
    ...
    <!-- Physiotherapy Section -->
    <section class="physiotherapy-section" id="physiotherapy-section" aria-labelledby="physiotherapy-heading">
        <h2 id="physiotherapy-heading"><i class="fas fa-running"></i> Physiotherapy</h2>
        <div class="physiotherapy-image">
            <img src="../photos/physiotherapy.jpg" alt="Physiotherapy at GreenLife Wellness Center" loading="lazy">
        </div>
        <p>Recover and regain mobility with tailored physiotherapy sessions designed to address pain and physical limitations. Our expert physiotherapists provide personalized treatment plans, including manual therapy, exercise programs, and rehabilitation techniques, to help you restore strength and improve quality of life.</p>

        <div class="physiotherapy-content">
            <div class="content-card">
                <img src="../photos/physiotherapy.webp" alt="Manual Therapy" loading="lazy">
                <h3>Manual Therapy</h3>
                <p>Hands-on techniques to relieve pain, improve joint mobility, and enhance muscle function. Ideal for treating conditions like back pain, neck pain, and joint stiffness.</p>
                <ul>
            ...
            <div class="content-card">
                <img src="../photos/upper-back-pain1.jpg" alt="Rehabilitation Programs" loading="lazy">
                <h3>Rehabilitation Programs</h3>
                <p>Customized exercise programs to restore strength, flexibility, and balance after injury or surgery. Perfect for post-operative recovery and chronic conditions.</p>
                <ul>
        ...
        <div class="booking-form">
            <h2><i class="fas fa-calendar-check"></i> Book Your Physiotherapy Session</h2>
            <div class="form-container">
                ...
                <form id="booking-form" method="POST">
                    ...
                    <div class="form-group">
                        <label for="booking-package"><i class="fas fa-box"></i> Physiotherapy Package</label>
                        <select id="booking-package" name="package" aria-label="Select a physiotherapy package" required onchange="updatePrice()">
                            <option value="" disabled selected>Select a package</option>
                            <option value="Manual Therapy">Manual Therapy</option>
                            <option value="Rehabilitation Program">Rehabilitation Program</option>
                            <option value="Pain Management Session">Pain Management Session</option>
                        </select>
    ...
    <script>
        ...
        function updatePrice() {
            ...
            const prices = {
                'Manual Therapy': 'LKR 7,000',
                'Rehabilitation Program': 'LKR 10,000',
                'Pain Management Session': 'LKR 8,000'
            };
