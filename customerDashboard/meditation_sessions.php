...
<head>
    ...
    <title>Meditation Sessions - GreenLife Wellness Center</title>
...
<body>
    ...
    <!-- Meditation Section -->
    <section class="meditation-section" id="meditation-section" aria-labelledby="meditation-heading">
        <h2 id="meditation-heading"><i class="fas fa-spa"></i> Meditation Sessions</h2>
        <div class="meditation-image">
            <img src="../photos/New-Project-5.jpg" alt="Meditation Sessions at GreenLife Wellness Center" loading="lazy">
        </div>
        <p>Find inner peace with guided meditation sessions designed to reduce stress and promote mindfulness. Our expert instructors guide you through various meditation techniques, including mindfulness meditation, loving-kindness meditation, and body scan practices, to enhance mental clarity and emotional well-being.</p>

        <div class="meditation-content">
            <div class="content-card">
                <img src="../photos/serene-meditation-session-stockcake.jpg" alt="Mindfulness Meditation" loading="lazy">
                <h3>Mindfulness Meditation</h3>
                <p>Learn to stay present and cultivate awareness through guided mindfulness meditation sessions. Perfect for beginners and experienced practitioners alike, these sessions help reduce stress and improve focus.</p>
                <a href="#booking-form">Learn More</a>
            </div>
            <div class="content-card">
                <img src="../photos/NW-Meditation-image-1080x1080-v2.webp" alt="Loving-Kindness Meditation" loading="lazy">
                <h3>Loving-Kindness Meditation</h3>
                <p>Foster compassion and emotional balance with loving-kindness meditation. This practice involves sending positive intentions to yourself and others, promoting a sense of connection and peace.</p>
                <a href="#booking-form">Learn More</a>
            </div>
        </div>

        <div class="booking-form">
            <h2><i class="fas fa-calendar-check"></i> Book Your Meditation Session</h2>
            <div class="form-container">
                ...
                <form id="booking-form" method="POST">
                    ...
                    <div class="form-group">
                        <label for="booking-package"><i class="fas fa-box"></i> Meditation Package</label>
                        <select id="booking-package" name="package" aria-label="Select a meditation package" required onchange="updatePrice()">
    ...
    <script>
        ...
        function updatePrice() {
            ...
            const prices = {
                'Mindfulness Meditation': 'LKR 5,000',
                'Loving-Kindness Meditation': 'LKR 5,000',
                'Body Scan Meditation': 'LKR 5,000'
            };
