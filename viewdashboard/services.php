    ...
    <style>
        ...
        * {
        ...
        .intro-section {
            text-align: center;
            padding: 80px 20px;
            background: url('../photos/IMG_3648-3.webp') no-repeat center/cover;
            color: #fff;
    ...
    <section class="services-section">
        ...
        <div class="services-grid">
            <div class="service-card">
                ...
                <a href="#ayurvedic-therapy">Learn More</a>
            </div>
            <div class="service-card">
                ...
                <a href="#yoga-classes">Learn More</a>
            </div>
            <div class="service-card">
                ...
                <a href="#meditation-sessions">Learn More</a>
            </div>
            <div class="service-card">
                ...
                <a href="#nutrition-consultation">Learn More</a>
            </div>
            <div class="service-card">
                ...
                <a href="#physiotherapy">Learn More</a>
            </div>
            <div class="service-card">
                ...
                <a href="#massage-therapy">Learn More</a>
            </div>
        </div>
    </section>
