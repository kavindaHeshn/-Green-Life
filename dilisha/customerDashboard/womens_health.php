...
<head>
    ...
    <title>Ayurvedic Women’s Health Package - GreenLife Wellness Center</title>
...
<body>
    ...
    <section class="intro-section">
        <h2>Ayurvedic Women’s Health Package</h2>
        <p>Empower your health with holistic therapies tailored for women’s well-being.</p>
    </section>

    <!-- Women’s Health Section -->
    <section class="womens-health" id="womens-health" aria-labelledby="womens-health-heading">
        <h2 id="womens-health-heading">Ayurvedic Women’s Health Package</h2>
        <img src="../photos/ayurvedic-breakfast-starting-your-day-right.webp" alt="Ayurvedic Women’s Health Package" class="health-image">
        <div class="health-content">
            <p>At GreenLife Wellness Center, our Ayurvedic Women’s Health Package is designed to support women’s unique health needs through holistic and natural therapies. This programme addresses hormonal balance, reproductive health, stress, and overall vitality, empowering women to feel their best at every stage of life.</p>
            
            <h3>Programme Highlights</h3>
            <ul>
                <li><strong>Panchakarma Therapy</strong>: Detoxification therapy to cleanse the body and promote hormonal balance.</li>
                <li><strong>Herbal Remedies</strong>: Utilizes herbs like Shatavari, Ashwagandha, and Lodhra to support reproductive health and hormonal balance.</li>
                <li><strong>Yoga & Meditation</strong>: Tailored sessions to enhance flexibility, reduce stress, and promote emotional well-being.</li>
                <li><strong>Personalized Diet</strong>: Dosha-specific meal plans to support reproductive health, digestion, and energy levels.</li>
                <li><strong>Counselling</strong>: Personalized sessions to address emotional and mental well-being.</li>
            </ul>

            <h3>Benefits</h3>
            <ul>
                <li>Regulates menstrual cycles and reduces PMS symptoms.</li>
                <li>Supports fertility and reproductive health naturally.</li>
                <li>Reduces stress, anxiety, and menopausal discomfort.</li>
                <li>Enhances skin health, energy, and overall vitality.</li>
                <li>Promotes emotional balance and inner strength.</li>
            </ul>
