...
<head>
    ...
    <title>Ayurvedic Therapy - GreenLife Wellness Center</title>
    ...
    <style>
        ...
        * {
        ...
        .intro-section {
            text-align: center;
            padding: 80px 20px;
            background: url('../photos/ayurvedic-bg.jpg') no-repeat center/cover;
            color: #fff;
...
<body>
    ...
    <!-- Ayurvedic Therapy Section -->
    <section class="ayurvedic-container" id="ayurvedic-section" aria-labelledby="ayurvedic-heading">
        <h2 id="ayurvedic-heading"><i class="fas fa-leaf"></i> Ayurvedic Therapy</h2>
        <div class="ayurvedic-image">
            <img src="../photos/ayurvedictherapy.png" alt="Ayurvedic Therapy at GreenLife Wellness Center" loading="lazy">
        </div>
        <p>Experience traditional Sri Lankan healing with personalized herbal treatments and therapies to restore balance and vitality. Our expert practitioners use time-honored Ayurvedic techniques, including herbal massages, Shirodhara, and customized herbal remedies, to promote holistic wellness and rejuvenation.</p>

        <div class="ayurvedic-content">
            <div class="content-card">
                <img src="../photos/swedish-massage-pexels-jonathan-borba-19641830-copy.jpg" alt="Shirodhara Therapy" loading="lazy">
                <h3>Shirodhara</h3>
                <p>A soothing treatment where warm herbal oil is poured in a continuous stream over the forehead to promote relaxation.</p>
                <ul>
            ...
            <div class="content-card">
                <img src="../photos/massage-therapy.jpg" alt="Herbal Massage" loading="lazy">
                <h3>Herbal Massage</h3>
                <p>A therapeutic massage using herbal oils to relieve pain and enhance overall well-being.</p>
                <ul>
                    <li>Pain Relief</li>
        ...
        <div class="booking-form">
            <h2><i class="fas fa-calendar-check"></i> Book Your Treatment</h2>
            <div class="form-container">
                ...
                <form id="booking-form" action="submit_booking.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="booking-package"><i class="fas fa-box"></i> Treatment</label>
                        <select id="booking-package" name="package" aria-label="Select a treatment" required onchange="updatePrice()">
                            <option value="" disabled selected>Select a treatment</option>
                            <option value="Cardiac Diseases">Cardiac Diseases</option>
                            <option value="Arthritis & Orthopaedic Diseases">Arthritis & Orthopaedic Diseases</option>
                            <option value="Liver Diseases">Liver Diseases</option>
                            <option value="Neurological Diseases">Neurological Diseases</option>
                            <option value="Gynaecological Diseases & Male Subfertility">Gynaecological Diseases & Male Subfertility</option>
                            <option value="Weight Loss Package">Weight Loss Package</option>
                            <option value="Dermatological Diseases">Dermatological Diseases</option>
                            <option value="Ayurvedic Cardiac Rehabilitation">Ayurvedic Cardiac Rehabilitation</option>
                        </select>
                    </div>
    ...
    <script>
        ...
        function updatePrice() {
            ...
            const prices = {
                'Cardiac Diseases': 'LKR 17,000',
                'Arthritis & Orthopaedic Diseases': 'LKR 15,000',
                'Liver Diseases': 'LKR 10,000',
                'Neurological Diseases': 'LKR 18,000',
                'Gynaecological Diseases & Male Subfertility': 'LKR 12,000',
                'Weight Loss Package': 'LKR 11,000',
                'Dermatological Diseases': 'LKR 14,000',
                'Ayurvedic Cardiac Rehabilitation': 'LKR 19,000'
            };
        ...
        document.getElementById('booking-form').addEventListener('submit', async function(event) {
            ...
            if (!name || !email || !emailRegex.test(email) || !package || !preferredDate || !preferredTime) {
            ...
            try {
                console.log('Submitting form to submit_booking.php');
                ...
                // No server error display; silently fail
            } catch (error) {
        ...
        document.getElementById('newsletter-form').addEventListener('submit', function(e) {
            ...
            // No error display for invalid email
        });
