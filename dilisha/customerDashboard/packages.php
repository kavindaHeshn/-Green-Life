...
<head>
    ...
    <title>Packages - GreenLife Wellness Center</title>
...
<body>
    ...
    <section class="intro-section">
        ...
        <p>Discover our tailored wellness packages designed to rejuvenate your body and mind at GreenLife Wellness Center.</p>
    </section>

    <!-- Packages Section -->
    <section class="packages-container">
        <h2><i class="fas fa-box"></i> Our Wellness Packages</h2>
        <div class="packages-grid">
            <div class="package-card">
                <img src="../photos/ayurvedictherapy.png" alt="Ayurvedic Therapy Package">
                <h3>Ayurvedic Therapy Package</h3>
                <p>Experience traditional Ayurvedic treatments with personalized herbal therapies and massages to rejuvenate your body and mind.</p>
                <div class="price">LKR 15,000</div>
                <div class="duration">3 Sessions (90 mins each)</div>
            </div>
            <div class="package-card">
                <img src="../photos/yoga-session.jpg" alt="Yoga & Meditation Retreat">
                <h3>Yoga & Meditation Retreat</h3>
                <p>Join our immersive yoga and meditation sessions to enhance flexibility, reduce stress, and achieve inner peace.</p>
                <div class="price">LKR 10,000</div>
                <div class="duration">5 Sessions (60 mins each)</div>
            </div>
            <div class="package-card">
                <img src="../photos/nutrition-consultation.webp" alt="Nutrition & Diet Consultation">
                <h3>Nutrition & Diet Consultation</h3>
                <p>Get a customized diet plan from our expert nutritionists to support your health goals and lifestyle.</p>
                <div class="price">LKR 8,000</div>
                <div class="duration">2 Consultations (45 mins each)</div>
            </div>
            <div class="package-card">
                <img src="../photos/massage-therapy.webp" alt="Physiotherapy & Massage">
                <h3>Physiotherapy & Massage</h3>
                <p>Relieve pain and improve mobility with our professional physiotherapy and therapeutic massage sessions.</p>
                <div class="price">LKR 12,000</div>
                <div class="duration">4 Sessions (60 mins each)</div>
            </div>
            <div class="package-card">
                <img src="../photos/physiotherapy.jpg" alt="Massage Therapy Package">
                <h3>Massage Therapy</h3>
                <p>Relax and rejuvenate with our therapeutic massage sessions.</p>
                <div class="price">LKR 9,000</div>
                <div class="duration">3 Sessions (60 mins each)</div>
            </div>
        </div>

        <div class="booking-form">
            <h2><i class="fas fa-calendar-check"></i> Book Your Package</h2>
            <div class="form-container">
                ...
                <form id="booking-form" method="POST">
                    ...
                    <div class="form-group">
                        <label for="booking-package"><i class="fas fa-box"></i> Package</label>
                        <select id="booking-package" name="package" aria-label="Select a package" required onchange="updatePrice()">
                            <option value="" disabled selected>Select a package</option>
                            <option value="Ayurvedic Therapy Package">Ayurvedic Therapy Package</option>
                            ...
                            <option value="Physiotherapy & Massage">Physiotherapy & Massage</option>
                    ...
                    <button type="submit"><span>Book packages</span></button>
                </form>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        function updatePrice() {
            ...
            const prices = {
                'Ayurvedic Therapy Package': 'LKR 15,000',
                'Yoga & Meditation Retreat': 'LKR 10,000',
                'Nutrition & Diet Consultation': 'LKR 8,000',
                'Physiotherapy & Massage': 'LKR 12,000',
                'Massage Therapy': 'LKR 9,000'
            };
        ...
        document.getElementById('booking-form').addEventListener('submit', async function(event) {
            ...
            try {
                ...
                document.getElementById('booking-server-error').textContent = 'Failed to submit booking. Please try again.';
                document.getElementById('booking-server-error').style.display = 'block';
            } finally {
                submitButton.disabled = false;
                submitButton.querySelector('span').textContent = 'Book Appointment';
