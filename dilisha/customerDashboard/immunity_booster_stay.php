...
<head>
    ...
    <title>Ayurvedic Immunity Booster Stay Package - GreenLife Wellness Center</title>
    ...
    <style>
        ...
        * {
        ...
        /* Immunity Booster Stay Package Section */
        .immunity-booster {
            padding: 60px 20px;
        ...
        .immunity-booster-content p {
            font-size: 1rem;
            color: #333;
            margin-bottom: 1.5rem;
        }

        .immunity-booster-content h3 {
            font-family: 'Algerian', serif;
            font-size: 1.8rem;
            color: var(--brown-accent);
            margin-bottom: 1rem;
        ...
        .immunity-booster-content ul {
            list-style: disc;
            padding-left: 20px;
            margin-bottom: 1.5rem;
        }

        .immunity-booster-content ul li {
            font-size: 1rem;
            color: #333;
            margin-bottom: 0.5rem;
        }

        .immunity-booster-content ul li strong {
            color: var(--brown-accent);
        }
...
<body>
    ...
    <section class="intro-section">
        <h2>Ayurvedic Immunity Booster Stay Package</h2>
        <p>Strengthen your immune system and enhance vitality with our holistic therapies.</p>
    </section>

    <!-- Immunity Booster Stay Package Section -->
    <section class="immunity-booster" id="immunity-booster" aria-labelledby="immunity-booster-heading">
        <h2 id="immunity-booster-heading">Ayurvedic Immunity Booster Stay Package</h2>
        <img src="../photos/opti-50_1-1-Kati-Wasthi.avif" alt="Ayurvedic Immunity Booster Stay Package" class="immunity-booster-image">
        <div class="immunity-booster-content">
            <p>At GreenLife Wellness Center, our Ayurvedic Immunity Booster Stay Package is designed to strengthen your immune system, detoxify your body, and enhance overall vitality through holistic Ayurvedic practices. This immersive program combines cleansing therapies, herbal remedies, and personalized nutrition to support long-term health and resilience.</p>
            
            <h3>Program Highlights</h3>
            <ul>
                <li><strong>Panchakarma Therapy</strong>: A comprehensive detoxification therapy to cleanse the body of toxins and boost immunity.</li>
                <li><strong>Herbal Remedies</strong>: Utilizes immune-boosting herbs like Tulsi, Guduchi, and Amalaki to enhance resilience.</li>
                <li><strong>Yoga & Meditation</strong>: Tailored asanas and meditation to promote mind-body balance and reduce stress.</li>
                <li><strong>Personalized Diet</strong>: Customized Ayurvedic meal plans to support immunity, digestion, and energy levels.</li>
                <li><strong>Counselling</strong>: Guidance to support mental and emotional well-being during your wellness journey.</li>
            </ul>

            <h3>Benefits</h3>
            <ul>
                <li>Strengthens the immune system to fight infections.</li>
                <li>Detoxifies the body for improved overall health.</li>
                <li>Increases energy levels and vitality.</li>
                <li>Enhances digestion and nutrient absorption.</li>
