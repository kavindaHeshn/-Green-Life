...
<head>
    ...
    <title>Yoga & Meditation - GreenLife Wellness Center</title>
...
<body>
    ...
    <section class="intro-section">
        ...
        <p>Join our transformative yoga and meditation programs to enhance your physical and spiritual well-being at GreenLife Wellness Center.</p>
    </section>

    <!-- Yoga Section -->
    <section class="yoga-section" id="yoga-section" aria-labelledby="yoga-heading">
        <h2 id="yoga-heading"><i class="fas fa-spa"></i> Yoga & Meditation</h2>
        <div class="yoga-image">
            <img src="../photos/Yoga-With-Meditation.webp" alt="Yoga & Meditation at GreenLife Wellness Center" loading="lazy">
        </div>
        <p>Join the ultimate yoga membership at GreenLife Wellness Center, designed for everyone from beginners to seasoned practitioners. Our programs offer a transformative experience through yoga, meditation, breathwork, Ayurveda, and yoga philosophy, with opportunities to earn yoga teaching certificates.</p>

        <div class="yoga-content">
            <div class="content-card">
                <img src="../photos/PFS-yoga-meditation.jpg" alt="Comprehensive Yoga Membership" loading="lazy">
                <h3>Comprehensive Yoga Membership</h3>
                <p>The only yoga membership you’ll ever need. Practice yoga, meditation, and breathwork, while deepening your understanding of Ayurveda and yoga philosophy. Perfect for all levels, our membership helps you grow spiritually and physically.</p>
                <a href="#booking-form">Learn More</a>
            </div>
            <div class="content-card">
                <img src="../photos/Kundalini-Yoga-and-Meditation.webp" alt="Advanced Education & Certification" loading="lazy">
                <h3>Advanced Education & Certification</h3>
                <p>For yoga teachers and advanced practitioners, we offer over 300 courses and curated challenges to enhance your yoga career and personal practice. Topics include:</p>
                <ul>
                    <li>Ayurveda</li>
                    <li>Longevity</li>
                    <li>Anatomy & Physiology</li>
                    <li>Mantras and Mudras</li>
                    <li>Spirituality</li>
                    <li>Pregnancy</li>
                    <li>Yoga Therapy</li>
                    <li>Tantra</li>
                ...
                <p>Earn yoga teaching certificates to advance your professional journey.</p>
                <a href="#booking-form">Learn More</a>
            </div>
        </div>

        <div class="booking-form">
            <h2><i class="fas fa-calendar-check"></i> Book Your Yoga Package</h2>
            <div class="form-container">
                ...
                <form id="booking-form" method="POST">
                    ...
                    <div class="form-group">
                        <label for="booking-package"><i class="fas fa-box"></i> Yoga Package</label>
                        <select id="booking-package" name="package" aria-label="Select a yoga package" required onchange="updatePrice()">
                            <option value="" disabled selected>Select a package</option>
                            <option value="Yoga & Meditation Membership">Yoga & Meditation Membership</option>
                            <option value="Yoga Teacher Training">Yoga Teacher Training</option>
                            <option value="Advanced Practitioner Courses">Advanced Practitioner Courses</option>
                        </select>
    ...
    <script>
        ...
        function updatePrice() {
            ...
            const prices = {
                'Yoga & Meditation Membership': 'LKR 8,000',
                'Yoga Teacher Training': 'LKR 12,000',
                'Advanced Practitioner Courses': 'LKR 10,000'
            };
