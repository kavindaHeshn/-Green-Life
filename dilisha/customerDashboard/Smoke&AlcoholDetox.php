...
<head>
    ...
    <title>Ayurvedic Smoke & Alcohol Detox Programme - GreenLife Wellness Center</title>
...
<body>
    ...
    <section class="intro-section">
        <h2>Ayurvedic Smoke & Alcohol Detox</h2>
        <p>Embark on a transformative journey to overcome addiction and restore your well-being.</p>
    </section>

    <!-- Detox Programme Section -->
    <section class="detox-programme" id="detox-programme" aria-labelledby="detox-heading">
        <h2 id="detox-heading">Ayurvedic Smoke & Alcohol Detox Programme</h2>
        <img src="../photos/addiction-recover.webp" alt="Ayurvedic Smoke & Alcohol Detox Programme" class="detox-image">
        <div class="detox-content">
            <p>At GreenLife Wellness Center, our Ayurvedic Smoke & Alcohol Detox Programme offers a holistic approach to overcoming addiction and restoring balance to your body and mind. Rooted in ancient Ayurvedic wisdom, this programme combines personalized therapies, herbal remedies, yoga, and meditation to detoxify your system, reduce cravings, and promote lasting wellness.</p>
            
            <h3>Programme Highlights</h3>
            <ul>
                <li><strong>Panchakarma Therapy</strong>: Includes Vamana (therapeutic vomiting), Virechana (purgation), and Basti (herbal enemas) to cleanse toxins and restore dosha balance.</li>
                <li><strong>Herbal Remedies</strong>: Utilizes herbs like Ashwagandha, Guduchi, and Shatavari to support liver health, reduce cravings, and enhance recovery.</li>
                <li><strong>Yoga & Meditation</strong>: Daily sessions to calm the mind, improve focus, and build resilience against addiction triggers.</li>
                <li><strong>Personalized Diet</strong>: Nutrient-rich, organic meals tailored to your dosha to support detoxification and organ recovery.</li>
                <li><strong>Counselling</strong>: One-on-one sessions to address psychological aspects of addiction and foster emotional well-being.</li>
            </ul>

            <h3>Benefits</h3>
            <ul>
                <li>Eliminates toxins from smoking and alcohol, improving liver and digestive health.</li>
                <li>Reduces cravings and withdrawal symptoms naturally.</li>
                <li>Enhances mental clarity, emotional balance, and overall vitality.</li>
                <li>Strengthens immunity and promotes long-term wellness.</li>
                <li>Provides a serene environment for healing and self-discovery.</li>
            </ul>
            ...
            <div class="booking-form">
                ...
                <form id="booking-form" action="../backend/submit_booking.php" method="POST" onsubmit="return validateBooking(event)">
                    ...
                    <select id="treatment" name="treatment" aria-label="Select a treatment package" aria-describedby="treatment-error" required>
                        ...
                        <option value="Personalized Diet">Personalized Diet</option>
