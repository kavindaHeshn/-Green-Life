...
<head>
    ...
    <title>Ayurvedic Mindfulness Package - GreenLife Wellness Center</title>
    ...
    <style>
        ...
        * {
        ...
        .mindfulness-content ul li {
            font-size: 1rem;
            color: #333;
            margin-bottom: 0.5rem;
        }

        .mindfulness-content ul li strong {
            color: var(--brown-accent);
        }
...
<body>
    ...
    <section class="intro-section">
        <h2>Ayurvedic Mindfulness Package</h2>
        <p>Cultivate inner peace and mental clarity with our holistic mindfulness therapies.</p>
    </section>

    <!-- Mindfulness Package Section -->
    <section class="mindfulness-package" id="mindfulness-package" aria-labelledby="mindfulness-heading">
        <h2 id="mindfulness-heading">Ayurvedic Mindfulness Package</h2>
        <img src="../photos/mindfulness.png" alt="Ayurvedic Mindfulness Package" class="mindfulness-image">
        <div class="mindfulness-content">
            <p>At GreenLife Wellness Center, our Ayurvedic Mindfulness Package is designed to cultivate mental clarity, reduce stress, and foster emotional balance through time-honored Ayurvedic practices. This holistic programme combines meditation, breathing techniques, and personalized therapies to promote inner peace and well-being.</p>
            
            <h3>Programme Highlights</h3>
            <ul>
                <li><strong>Yoga & Meditation</strong>: Guided sessions combining yoga asanas and meditation to enhance focus and emotional stability.</li>
                <li><strong>Herbal Remedies</strong>: Utilizes herbs like Brahmi and Ashwagandha to support cognitive function and mental resilience.</li>
                <li><strong>Panchakarma Therapy</strong>: Detoxification therapy to cleanse the body and mind, promoting relaxation.</li>
                <li><strong>Personalized Diet</strong>: Customized Ayurvedic meal plans to support mental clarity and overall health.</li>
            ...
            <ul>
                ...
                <li>Improves focus, concentration, and mental clarity.</li>
                <li>Enhances emotional stability and resilience.</li>
                <li>Promotes better sleep and relaxation.</li>
                <li>Strengthens the mind-body connection for overall well-being.</li>
            </ul>
